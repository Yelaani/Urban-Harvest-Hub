                    ...
                    <div className="rounded-md shadow-sm -space-y-px">
                        <div className="relative">
                            ...
                            <input
                                type="text"
                                required
                                className="appearance-none rounded-none relative block w-full px-10 py-3 border border-neutral-300 dark:border-slate-600 bg-white dark:bg-slate-700 placeholder-neutral-500 dark:placeholder-slate-400 text-neutral-900 dark:text-slate-200 rounded-t-md focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 focus:z-10 sm:text-sm"
                        ...
                        <div className="relative">
                            ...
                            <input
                                type="password"
                                required
                                className="appearance-none rounded-none relative block w-full px-10 py-3 border border-neutral-300 dark:border-slate-600 bg-white dark:bg-slate-700 placeholder-neutral-500 dark:placeholder-slate-400 text-neutral-900 dark:text-slate-200 rounded-b-md focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 focus:z-10 sm:text-sm"
