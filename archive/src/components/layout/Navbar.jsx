                ...
                <div className="flex justify-between h-16">
                    ...
                    <div className="flex items-center">
                        <Link to="/" className="flex items-center space-x-2">
                            ...
                            <span className="text-xl font-bold text-slate-800 tracking-tight">Urban Harvest Hub</span>
                        </Link>
                    </div>
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        {navLinks.map((link) => (
                            <NavLink
                                ...
                                to={link.path}
                                className={({ isActive }) =>
                                    `text-sm font-medium transition-colors duration-200 ${isActive ? 'text-urban-green' : 'text-slate-600 hover:text-urban-green'
                                    }`
                                }
                            >
                                {link.name}
                        ...
                        {/* Cart Icon */}
                        <Link to="/checkout" className="relative p-2 text-slate-600 hover:text-urban-green transition-colors" aria-label="View Cart">
                    ...
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        {navLinks.map((link) => (
                            <NavLink
                                ...
                                className={({ isActive }) =>
                                    `block px-3 py-2 rounded-md text-base font-medium ${isActive ? 'text-urban-green bg-green-50' : 'text-slate-600 hover:text-urban-green hover:bg-slate-50'
                                    }`
                                }
                            >
                                {link.name}
