...
const Details = () => {
    ...
    if (!item) {
        return <div className="text-center py-20 text-xl text-slate-500">Item not found.</div>;
    }
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <button
                onClick={() => navigate(-1)}
                className="flex items-center text-slate-600 hover:text-urban-green mb-6 transition-colors"
            >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                {/* Info Section */}
                <div>
                    <h1 className="text-4xl font-bold text-slate-800 mb-2">{item.title}</h1>
                            ...
                            {loadingWeather ? (
                                ...
                                <div className="flex items-center space-x-8">
                                    <div className="flex flex-col items-center">
                                        ...
                                        <span className="text-sm text-slate-500 mt-1">{weather.condition}</span>
                                    </div>
                                ...
                                <p className="text-sm text-slate-500">Weather data currently unavailable.</p>
                            )}
                        </div>
                    )}
                </div>
